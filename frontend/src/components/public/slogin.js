...
class Slogin extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>{this.state.isAuth && this.state.me == 'student'?(<Redirect isAuth={this.state.isAuth} to="/student/home"/>):(
           <div id="backlogin" >
           <Nav/>
               <form method="post" onSubmit={this.onSubmit} >
                  <div className="container " ><br/><br/>
                      <div className="card card-header mx-auto col-md-5" id="form"> 
                          {/* <img  className='justify-center' src={logo} style={{width:'180px'}}></img> <hr/> */}
